...
public class SudokuPanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		g2d.setColor(new Color(1.0f, 1.0f, 1.0f)); ///Sudoku Background Color
		...
		g2d.setColor(new Color(0.0f, 0.0f, 0.0f)); ///grid and number color
		...
		if (currentlySelectedCol != -1 && currentlySelectedRow != -1) {
			...
			g2d.setColor(new Color(0.0f, 1.0f, 1.0f, 0.3f));
	...
	public void messageFromNumActionListener(String buttonValue) {
		...
		if (currentlySelectedCol != -1 && currentlySelectedRow != -1) {
			...
			puzzle.makeMoveClick(currentlySelectedRow, currentlySelectedCol, buttonValue, true);
			repaint();
	...
	public class NumKeyActionListener implements KeyListener {
		...
		public void keyPressed(KeyEvent e) {
			if (e.getKeyCode() == KeyEvent.VK_9)
				...
				messageFromNumActionListener("0");
