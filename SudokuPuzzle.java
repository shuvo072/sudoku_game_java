...
public class SudokuPuzzle {
	...
	public void makeMoveClick(int row, int col, String value, boolean isMutable) {
		...
		if (boardFull()) {
			for(long i = 0; i < 1000000000; i++) continue;
			JOptionPane.showMessageDialog(null, "You Have Completed in: " +time, "Score", 1); ///Sudoku Completed
			MyMenu.main(new String[] {});
		}
	}
